    ...
    <Layout>
      <Wrapper data ={data} >
        <Img fluid={photo.img.childImageSharp.fluid} />
          ...
          However, I don't think it is bad since speaking a language is always about arranging and combining what you know, right?
          At the end of the day, Duolingo is the most popular language learning app, why not give it a shot!
          <h2>Execution</h2>
          I played Duolingo for about half an hour every week day and 2 hours on Saturday and Sunday.
          Meaning about 54 hours in total. Wow that's so much less than I thought!
          ...
          <h3>・Grammar / Vocabulary</h3>
            ...
            Especially, I'm very happy that I know much better about articles, dative, accusative and all that ugly stuff in German.
            I have also achieved the ability to say what I want to say in everyday situations if I'm given enough time.
            <br/>
            <br/>
          ...
          <h2>Was it a waste of time?</h2>
            ...
            even though it takes sometime to understand the whole context. So it's working but doesn't get you to a practical level.
            Like I said before, if you are fluent in one of the western languages and willing to learn another western language,
            it is definitely a great option especially when you start from zero.
            <br/><br/>
